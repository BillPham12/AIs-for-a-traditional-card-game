...
import robotStrategy.Aggressive;
...
public class AggressivePlayer extends Client
{

    public AggressivePlayer(String name) { super(name);
        ServerPort = 1234;
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        AggressivePlayer player = new AggressivePlayer("AGGRESSION");
    ...
    private static void playNewTurn(DataOutputStream out,AggressivePlayer player) throws IOException {
    ...
    private static void reNewTurn(AggressivePlayer player){
    ...
    private static void reNewRound (AggressivePlayer player, String enemy){
        ArrayList<String> sample = new ArrayList<>();
        sample.addAll(player.schedule);
    ...
    private static void reNewTurnAgressiveTakingTheLead(AggressivePlayer player){
        ArrayList<String> sample = new ArrayList<>();
        sample.addAll(player.schedule);
