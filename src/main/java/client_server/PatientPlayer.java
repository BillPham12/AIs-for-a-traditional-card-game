...
public class PatientPlayer extends Client
{
    public PatientPlayer(String name) { super(name);
        ServerPort = 2345;
        hand = new ArrayList<String>();
        strategy = new Patient();
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        PatientPlayer player = new PatientPlayer("PATIENCE");
                        ...
                        // because this is robot then we don't need to anything
                          ...
                          //  System.out.println(enemy + "----- Next Round is " + player.turns);
                            ...
                            if(!enemy.equals("SERVER") && cards.equals("03;")){
                                ...
                                else if(player.turns.peek().equals(name)){
    ...
    private static void playNewTurn(DataOutputStream out,PatientPlayer player) throws IOException {
    ...
    private static void reNewTurn(PatientPlayer player){
    ...
    private static void reNewTurnAgressiveTakingTheLead(PatientPlayer player){
        ArrayList<String> sample = new ArrayList<>();
        sample.addAll(player.schedule);
    ...
    private static void reNewRound (PatientPlayer player, String enemy){
        ArrayList<String> sample = new ArrayList<>();
        sample.addAll(player.schedule);
