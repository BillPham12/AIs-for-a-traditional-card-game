...
public class PatientAndRationalPlayer extends Client
{
    public PatientAndRationalPlayer(String name) { super(name);
        ServerPort = 2222;
        hand = new ArrayList<String>();
        strategy = new Rational_Patient();
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        PatientAndRationalPlayer player = new PatientAndRationalPlayer("TERMINATOR");
    ...
    private static void playNewTurn(DataOutputStream out,PatientAndRationalPlayer player) throws IOException {
    ...
    private static void reNewTurn(PatientAndRationalPlayer player){
    ...
    private static void reNewTurnAgressiveTakingTheLead(PatientAndRationalPlayer player){
        ArrayList<String> sample = new ArrayList<>();
        sample.addAll(player.schedule);
    ...
    private static void reNewRound (PatientAndRationalPlayer player, String enemy){
        ArrayList<String> sample = new ArrayList<>();
        sample.addAll(player.schedule);
